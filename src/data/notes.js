...
// the beats sum to about 24, the rest is buffer before the hard stop.
export const notes = {
  ...
  'divider-where-ai-belongs': 'Target 14:00. Transition. Now that they can articulate, where does the probabilistic tool actually go.',
  'deterministic-vs-probabilistic': 'Target 14:30. Line to land: you already run a probabilistic system, it\'s called a tech at 4pm on a Tuesday, measure both. Read both columns aloud, do not just point at them.',
  'guardrail-sandwich': 'Target 16:30. Callback to Right of Boom, two minutes not eight. Emphasize the check step, most rooms do gather, validate, draft and skip it. Land on: the AI never touches the customer or the system of record unguarded.',
  'honest-limit': 'Target 19:30. Line to land: the cost of AI isn\'t tokens, it\'s review. Sets up Bradley Gross on contracts at 3:15: a client can\'t audit a vibe, they can audit a log.',
  'what-you-do-with-the-hours': 'Target 21:30. Close the loop with slide 3. You started with intent not surviving the handoff between people. The hours you get back go to the handoffs where it does: the QBR, the ticket update, the onboarding call with the human present. Line to land: your best ticket-note writer is your best automation engineer.',
  'one-action': 'Target 23:30. End on the Table 3 handoff, not a thank you. Point at the room. One hour, one page, bring it to the table.',
  presenter: 'Target 24:30. One breath. Name, company, one sentence, move on. Roughly 5 minutes left as buffer before the hard stop.',
}
