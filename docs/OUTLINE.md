...
11. Exists means said out loud (two-column, orange). The shop example, no AI in it. "We have an offboarding process." You have Mike. You turn his checklist into an automation; it runs perfectly for a year; then license reconciliation finds nine ex-employees still holding CAD seats, billed monthly to a card nobody reconciles. Nobody skipped a step. The CAD tool was never on the list because Mike set up that client's engineering group and knew. The list was complete and wrong. An automation is just the next person who is not Mike, and the first that cannot fill in the blank. Card: nothing failed. Callback to the Sizers: margin leaking through a process you thought you had. Bridge out: true of every one of the six, and why most shops automate the wrong ones.
