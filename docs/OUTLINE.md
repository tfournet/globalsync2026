...
11. Exists means said out loud (two-column, orange). The shop example, no AI in it. "We have an offboarding process." You have Mike. You turn his checklist into an automation; it runs perfectly for a year; then license reconciliation finds nine ex-employees still holding Adobe seats, billed monthly since they left. Nobody skipped a step. Adobe was never on the list because Mike set up that client's marketing team and knew. The list was complete and wrong. An automation is just the next person who is not Mike, and the first that cannot fill in the blank. Card: nothing failed. Callback to the Sizers: margin leaking through a process you thought you had. Bridge out: true of every one of the six, and why most shops automate the wrong ones.
