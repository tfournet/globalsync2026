...
11. Exists means said out loud (two-column, orange). The shop example, no AI in it. "We have an offboarding process." You have Mike. It works until Mike isn't the one doing it; the OneDrive sync was in his head, not on the checklist; the first time someone else runs it, you find out. Mike was on vacation, the covering tech ran every box, nobody skipped a step, the step was never on the list. An automation is just the next person who is not Mike. Card: nothing failed. You turned the checklist into an automation, it ran perfectly, and the next offboarding showed OneDrive was never on it. The checklist was complete and wrong; the automation is the first receiver that cannot fill in the blank. Now you know what Mike knows. Bridge out: true of every one of the six coming next, and why most shops automate the wrong ones.
