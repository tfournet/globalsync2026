...
3. Where the automation project stops (bullets, blue). You pick a process and sit down to map it. The first steps are easy, then one your tech does from memory. Ask what they decide there and the answer is it depends. The project stalls and the tech keeps doing it by hand. This is the missing step between the fear and the cause: it was not automation that failed, it was that step. Next slide is what it depends is made of.
...
13. The list was followed. The process still didn't exist. (two-column, orange) The shop example, no AI in it. "We have an offboarding process." You have Mike. The list said "cancel software licenses." The covering tech canceled Microsoft; Mike meant Microsoft, Adobe, and the two tools you forgot. Found at the next license reconciliation: nine ex-employees holding Adobe seats for a year. Nobody skipped a step; the line was there, the meaning was not. Same failure as "on top of it": a phrase with a full definition in the writer's head and a smaller one in the reader's. Card, what it cost and what it costs to fix: a senior tech who cannot take vacation; every offboarding done twice; one hour, ask Mike which licenses, write it down. This is where the title lives: the hire was insurance against a definition of done that lived in one person. Say it out loud and you do not need the insurance. More with less means fewer people needed to make a process safe, not fewer people. Bridge out: true of every process that lives in one person, and why most shops automate the wrong ones.

14. Most MSPs automate the wrong things (comparison, orange). Automating the customer away: ticket auto-replies, templated QBRs, onboarding nobody attends. Automating the automaton: reading one screen and typing into another, checking the same thing every morning, chasing the same approval. Line: automate to give time back to the customer, not to hide from them. Bridge: once the automaton work is written down, two machines can take it; the next three slides are which gets what.
...
19. The more (two-column, blue). SLOW. Your customers have automatons too: invoices, approvals, onboarding, renewals. Nobody is selling them the fix. You get hours to be present, a case study they watched you build, the next line on the invoice.
