...
3. Which alert is noise. Which client gets the short version. Which ticket gets a phone call. Orange: those are decisions, and they are not in any document you own. Eyebrow: what they decide all day. SLOW. Slide 2 is the person, slide 3 is a piece of what they carry. Note tells one case (the 2am alert that clears itself and the identical one that does not) rather than reading the list. No Adobe here; that line belongs to Mike at slide 12. Bridge to 4: here is how it got that way.
