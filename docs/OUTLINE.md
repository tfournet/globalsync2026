...
3. Every automation project stalls at the same step (bullets, blue). You pick something they do, and the first six steps go fine. Step seven is the one they do from memory. You ask what they decide there, and they say it depends. The tech keeps doing it by hand, and you decide automation is not ready for your shop. Note names the scheduling objection: the second mapping session never happened because the next step had no answer. Bridge: next slide is what it depends is made of.
